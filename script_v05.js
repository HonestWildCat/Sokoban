...
const levels = {
	...
	"11":{
		"lvl":[
				[4,4,4,4,9,9,9,4,4,4,4,4],
				[4,0,0,4,4,4,4,4,0,0,4,4],
				[4,0,1,4,2,0,2,4,1,0,4,4],
				[4,0,0,2,2,5,2,2,0,0,4,4],
				[4,0,1,4,2,0,2,4,1,0,4,4],
				[4,0,0,4,0,4,0,4,0,0,4,4],
				[4,0,1,4,0,4,0,4,1,0,4,4],
				[4,0,0,4,0,4,0,4,0,0,4,4],
				[4,0,1,4,0,4,0,4,1,0,4,4],
...
"12":{
	"lvl":[
			[4,4,4,4,4,9,9,9,9,9,9,9],
			[4,0,0,0,4,4,4,4,4,4,4,4],
			[4,0,5,1,0,0,0,0,0,0,4,4],
			[4,4,0,1,2,4,4,4,4,0,4,4],
			[9,4,0,1,3,1,0,0,4,0,4,4],
			[9,4,4,0,2,2,2,0,4,0,4,4],
			[9,9,4,0,0,4,0,4,4,0,4,4],
			[9,9,4,4,4,4,0,0,0,0,4,4],
			[9,9,9,9,9,4,4,4,4,4,4,4]
			],
	"passed": false},
