...
"passed": false},
	...
	"11":{
		"lvl":[
			[9,9,9,4,4,4,9,9,9,9,9,4,4,4,9,9,9,9],
			[9,9,4,4,2,4,4,9,9,9,4,4,2,4,4,9,9,9],
			[9,4,4,2,1,2,4,4,9,4,4,2,1,2,4,4,9,9],
			[4,4,2,1,0,1,2,4,4,4,2,1,0,1,2,4,4,4],
			[4,2,1,0,1,0,1,0,2,1,1,0,1,0,1,2,4,4],
			[4,4,2,1,0,1,0,4,0,4,0,1,0,1,2,4,4,4],
			[9,4,4,2,1,0,1,2,0,2,1,0,1,2,4,4,9,9],
			[9,9,4,2,0,4,2,4,1,4,2,4,0,4,4,9,9,9],
			[9,9,4,4,2,1,2,1,5,1,2,1,2,4,4,9,9,9],
			[9,9,4,4,0,4,2,4,1,4,2,4,0,2,4,9,9,9],
			[9,4,4,2,1,0,1,2,0,2,1,0,1,2,4,4,9,9],
			[4,4,2,1,0,1,0,4,0,4,0,1,0,1,2,4,4,4],
			[4,2,1,0,1,0,1,1,2,0,1,0,1,0,1,2,4,4],
			[4,4,2,1,0,1,2,4,4,4,2,1,0,1,2,4,4,4],
			[9,4,4,2,1,2,4,4,9,4,4,2,1,2,4,4,9,9],
			[9,9,4,4,2,4,4,9,9,9,4,4,2,4,4,9,9,9],
			[9,9,9,4,4,4,9,9,9,9,9,4,4,4,9,9,9,9]
...
"12":{
"lvl":[
[4,4,4,4,4,4,4,9,9,9,9],
[4,0,0,0,0,0,4,9,9,9,9],
[4,0,4,4,4,0,4,9,9,9,9],
[4,0,4,5,4,0,4,4,4,4,4],
[4,0,1,1,1,1,1,0,0,0,4],
[4,0,4,0,4,0,4,0,4,0,4],
[4,0,2,2,2,2,2,0,0,0,4],
[4,4,4,0,0,4,4,4,4,4,4],
[9,9,4,0,0,4,9,9,9,9,9],
...
let img1 = new Image();
img1.src = 'img/target.png';
let img2 = new Image();
img2.src = 'img/Place1.png';
let img3 = new Image();
img3.src = 'img/target2.png';
let img4 = new Image();
img4.src = 'img/wall.png';
        ...
        for(let j = 0; j < cellsOnX; j++){
            ...
            switch(objArr[i][j]){
                ...
                case 1: // target
                    ...
                    //canvas.fillRect(j * cellSize, i * cellSize, cellSize, cellSize);					
					ctx.drawImage(img1, j * cellSize, i * cellSize, cellSize, cellSize);	
                    break;
                case 2: // place
                    //canvas.fillStyle = "#AB4E52";
                    //canvas.fillRect(j * cellSize, i * cellSize, cellSize, cellSize);
					ctx.drawImage(img2, j * cellSize, i * cellSize, cellSize, cellSize);
                    break;
                case 3: // target on place
                    //canvas.fillStyle = "#87A96B";
                    //canvas.fillRect(j * cellSize, i * cellSize, cellSize, cellSize);
					ctx.drawImage(img3, j * cellSize, i * cellSize, cellSize, cellSize);
                    break;
                case 4: // wall
                    //canvas.fillStyle = "#A2ACB8";
                    //canvas.fillRect(j * cellSize, i * cellSize, cellSize, cellSize);
					ctx.drawImage(img4, j * cellSize, i * cellSize, cellSize, cellSize);
                    break;
                case 5: // player
